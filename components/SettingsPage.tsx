...
const SettingsPage: React.FC<Props> = ({ user, setUser, t }) => {
             ...
             <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4 p-6 bg-slate-950/50 rounded-3xl border border-white/5">
                   ...
                   <p className="text-[8px] text-slate-600 font-bold uppercase tracking-widest">
                      O IRS será deduzido {formUser.irs.type === 'percentage' ? 'como percentagem do bruto' : 'como valor fixo mensal'}.
                   </p>
                </div>
                ...
                <div className="space-y-4 p-6 bg-slate-950/50 rounded-3xl border border-white/5">
                   ...
                   <p className="text-[8px] text-slate-600 font-bold uppercase tracking-widest">
                      A TSU será deduzida {formUser.socialSecurity.type === 'percentage' ? 'sobre o salário bruto' : 'como valor fixo independente'}.
                   </p>
                </div>
             </div>
          </div>
